...
// https://github.com/realm/realm-core/blob/94be9e3fa9d0c5861d9788cbc5e372f12586593b/src/external/mpark/variant.hpp
...
#pragma warning(pop)
            ...
            detail::is_nothrow_invocable_r<is_invocable_r<R, F, Args...>::value, R, F,
                    Args...>;
...
#define DECLTYPE_AUTO_RETURN(...) \
  ->decltype(__VA_ARGS__) { return __VA_ARGS__; }
    ...
    namespace detail {
        ...
        enum class Trait {
            TriviallyAvailable, Available, Unavailable
        };
        ...
        namespace access {
            ...
            struct base {
                ...
                AUTO_REFREF_RETURN(recursive_union::get_alt(lib::forward<V>(v).data_,
                                                            in_place_index_t<I>{}))
#else AUTO_REFREF_RETURN(recursive_union::get_alt(data(lib::forward<V>(v)),
                                                  in_place_index_t<I>{}))
            ...
            struct variant {
                template<std::size_t I, typename V>
                inline static constexpr AUTO_REFREF get_alt(V &&v) AUTO_REFREF_RETURN(base::get_alt<I>(lib::forward<V>(v).impl_))
            };
            ...
            struct base {
                ...
                struct visit_return_type_check {
                    ...
                    inline static constexpr DECLTYPE_AUTO invoke(Visitor &&visitor,
                                                                 Alts &&...alts) DECLTYPE_AUTO_RETURN(lib::invoke(lib::forward<Visitor>(visitor),
    ...
    (!defined(_MSC_VER) || _MSC_VER >= 1910)
...
#ifdef MPARK_VARIANT_SWITCH_VISIT DECLTYPE_AUTO_RETURN(
                        base::dispatcher<
            ...
            private:
                ...
                struct visit_exhaustiveness_check {
                    ...
                    inline static constexpr DECLTYPE_AUTO invoke(Visitor &&visitor,
                                                                 Values &&...values) DECLTYPE_AUTO_RETURN(lib::invoke(lib::forward<Visitor>(visitor),
                                                                                                                      lib::forward<Values>(
                                                                                                                              values)...))
                };
                ...
                template<typename Visitor>
                inline static constexpr AUTO make_value_visitor(Visitor &&visitor) AUTO_RETURN(value_visitor<Visitor>{lib::forward<Visitor>(visitor)})

            public
                :
                template<typename Visitor, typename... Vs>
                inline static constexpr DECLTYPE_AUTO
                visit_alt(Visitor &&visitor, Vs &&...vs) DECLTYPE_AUTO_RETURN(alt::visit_alt(lib::forward<Visitor>(visitor),
                ...
                template<typename Visitor, typename... Vs>
                inline static constexpr DECLTYPE_AUTO
                visit_value_at(std::size_t index, Visitor &&visitor, Vs &&...vs) DECLTYPE_AUTO_RETURN(visit_alt_at(
   ...
   protected:                                                             \
    destroy                                                               \
        ...
        MPARK_VARIANT_DESTRUCTOR(
                Trait::TriviallyAvailable, ~destructor() = default;, inline void destroy() noexcept {
        ...
        MPARK_VARIANT_DESTRUCTOR(Trait::Unavailable, ~destructor() = delete;, inline void destroy() noexcept = delete;);
...
#undef MPARK_INHERITING_CTOR
    ...
    namespace detail {
        ...
        struct generic_get_impl {
            ...
            constexpr AUTO_REFREF operator()(V &&v) const AUTO_REFREF_RETURN(access::variant::get_alt<I>(lib::forward<V>(v)).value)
        };

        template<std::size_t I, typename V>
        inline constexpr AUTO_REFREF generic_get(V &&v) AUTO_REFREF_RETURN(generic_get_impl<I, V>(holds_alternative<I>(v)
                                                                                                  ? 0
    ...
    namespace detail {
        ...
        template<std::size_t I, typename V>
        inline constexpr /* auto * */ AUTO generic_get_if(V *v) noexcept AUTO_RETURN(v && holds_alternative < I > (*v)
